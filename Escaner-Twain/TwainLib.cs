        ...
        public void Select()
        {
            try
            {
                ...
                if (appid.Id == IntPtr.Zero)
                {
                    Init(hwnd);
                    if (appid.Id == IntPtr.Zero)
                        MessageBox.Show("No hay aplicaciones de escaner conectados", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
            ...
            {
                MessageBox.Show(ex.Message, "My Exception", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
